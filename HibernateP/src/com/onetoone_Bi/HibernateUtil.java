...
public class HibernateUtil {
	...
	public static SessionFactory getSessionFactory(){
		...
		if(sf==null){
			...
			m.put(Environment.URL, "jdbc:mysql://localhost:3306/xe");
			...
			MetadataSources ms=new MetadataSources(registry).addAnnotatedClass(PersonBill.class).addAnnotatedClass(PersonP.class);
