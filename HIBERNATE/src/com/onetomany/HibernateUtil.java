...
public class HibernateUtil {
	...
	public static SessionFactory getSessionFactory(){
		...
		if(sf==null){
			...
			m.put(Environment.URL, "jdbc:mysql://localhost:3306/mprac26");
			...
			MetadataSources ms=new MetadataSources(registry).addAnnotatedClass(Person.class).addAnnotatedClass(PersonBills.class);
