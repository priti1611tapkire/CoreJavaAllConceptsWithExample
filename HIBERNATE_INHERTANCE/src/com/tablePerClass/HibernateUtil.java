...
private static StandardServiceRegistry registry=null;
	...
	public static SessionFactory getSessionFactory(){
		...
		if(sf==null){
			...
			m.put(Environment.URL, "jdbc:mysql://localhost:3306/has_a_relationshiphibernate");
			...
			MetadataSources ms=new MetadataSources(registry).addAnnotatedClass(Cjckkk.class).addAnnotatedClass(Karvenagarksk.class).addAnnotatedClass(Akurdisks.class);
